...
SECTIONS
{
    ...
    .int36       : {}               > INT36
    .int37       : {}               > INT37
    AES256       : { * ( .int38 ) } > INT38 type = VECT_INIT
    RTC          : { * ( .int39 ) } > INT39 type = VECT_INIT
    PORT4        : { * ( .int40 ) } > INT40 type = VECT_INIT
    PORT3        : { * ( .int41 ) } > INT41 type = VECT_INIT
    ...
    USCI_A1      : { * ( .int51 ) } > INT51 type = VECT_INIT
